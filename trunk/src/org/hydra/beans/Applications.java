...
public class Applications extends ALogger {
	...
	private CassandraAccessorBean cassandraAccessor = null;
	...
	public void setApplications(Set<Application> inApplicationsSet){
		...
		if(getLog().isDebugEnabled()) for(Application app:inApplicationsSet) getLog().debug(app.getId());
	...
	public void setCassandraAccessor(CassandraAccessorBean cassandraAccessor) {
		this.cassandraAccessor = cassandraAccessor;
	}
	public CassandraAccessorBean getCassandraAccessor() {
		return cassandraAccessor;
	}
}
